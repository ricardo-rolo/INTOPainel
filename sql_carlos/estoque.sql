         ...
         WHERE e.cd_estoque = es.cd_estoque
           AND es.cd_produto IN
               (SELECT cd_produto
                ...
                WHERE ('N' = 'N' AND a.cd_produto = p.cd_produto)
                   OR ('N' = 'S' AND a.cd_produto = p.cd_produto)
               )
...
SET DEFINE OFF;
Insert into DBAMV.VDIC_ESTOQUE_COVID (CD_PRODUTO, DS_PRODUTO, QT_ESTOQUE, DS_UNIDADE)
values ('154590', 'MASCARA PARA PROTEÇÃO CONTRA BACILO DE BAAR', '1875', 'UNIDADE');
Insert into DBAMV.VDIC_ESTOQUE_COVID (CD_PRODUTO, DS_PRODUTO, QT_ESTOQUE, DS_UNIDADE)
values ('154614', 'OCULOS DE PROTEÇÃO', '2317', 'UNIDADE');
Insert into DBAMV.VDIC_ESTOQUE_COVID (CD_PRODUTO, DS_PRODUTO, QT_ESTOQUE, DS_UNIDADE)
values ('202592', 'MASCARA DESCART. TRIPLA C/FILT.BACT.GRAMAT.30CM VISCOS CX-50', '9750', 'UNIDADE');
Insert into DBAMV.VDIC_ESTOQUE_COVID (CD_PRODUTO, DS_PRODUTO, QT_ESTOQUE, DS_UNIDADE)
values ('33020103', 'AVENTAL DE PROCEDIMENTO - AMARELO', '8288', 'UNIDADE');
